...
class TestWhatsAppFlowMessage(FrappeTestCase):
    ...
    def test_flow_message_structure(self):
        ...
        from whatsapp_evolution.whatsapp_evolution.doctype.whatsapp_message.whatsapp_message import WhatsAppMessage
...
class TestFlowEndpoint(FrappeTestCase):
    ...
    def test_health_check(self):
        ...
        from whatsapp_evolution.whatsapp_evolution.api.flow_endpoint import handle_init
