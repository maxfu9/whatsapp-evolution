...
from whatsapp_evolution.utils.webhook import (
...
class TestWebhookEndpoint(IntegrationTestCase):
    ...
    def test_webhook_get_verification(self):
        ...
        with patch("whatsapp_evolution.utils.webhook.frappe.request", mock_request):
            from whatsapp_evolution.utils.webhook import webhook
            response = webhook()
